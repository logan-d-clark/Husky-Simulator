...
export const ITEMS: Record<ItemType, ItemInfo> = {
  rawhide: {
    ...
    keyCode: 49,
    name: 'Rawhide',
    blurb: 'Drop it and Bandit comes running from anywhere on the map — then he '
  ...
  repeller: {
    ...
    blurb: 'Drop it to fence off a patch of the neighbourhood. Bandit will not '
  ...
  diaper: {
    ...
    keyCode: 51,
    name: 'Doggy Diaper',
    blurb: 'Empties your poop and pee to nothing on the spot — and leaves the '
  ...
  zoomies: {
    ...
    keyCode: 52,
    name: 'Zoom Zoom Chew',
    blurb: 'Caffeinated. You lose the wheel for half a minute while Blizzard '
